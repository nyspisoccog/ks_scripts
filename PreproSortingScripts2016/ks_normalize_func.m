...
for i = 1:length(subjects)
    ...
    matlabbatch{3}.spm.tools.dartel.mni_norm.data.subj(i).flowfield = ...
        cellstr(spm_select('FPList', fullfile(data_path, subject,'anat'), '^u.*\.nii$'));  
    matlabbatch{3}.spm.tools.dartel.mni_norm.data.subj(i).images = o;
end
...
matlabbatch{3}.spm.tools.dartel.mni_norm.vox = [2 2 2];
matlabbatch{3}.spm.tools.dartel.mni_norm.bb = [NaN NaN NaN
                                               NaN NaN NaN];
matlabbatch{3}.spm.tools.dartel.mni_norm.preserve = 0;
matlabbatch{3}.spm.tools.dartel.mni_norm.fwhm = [6 6 6];

matlabbatch{4}.spm.tools.dartel.mni_norm.template = temp;

for i = 1:length(subjects)
    subject = subjects(i).ID;
    matlabbatch{4}.spm.tools.dartel.mni_norm.data.subj(i).flowfield = ...
        cellstr(spm_select('FPList', fullfile(data_path, subject,'anat'), '^u.*\.nii$'));  
    matlabbatch{4}.spm.tools.dartel.mni_norm.data.subj(i).images = ...
