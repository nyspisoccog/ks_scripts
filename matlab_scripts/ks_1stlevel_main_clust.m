...
Data.bp_ons_dir  = [rtdir 'onsets/noMV_noval_1stv2nd_wbp/bp'];
Data.lrn_ons_dir = [rtdir 'onsets/noMV_noval_1stv2nd_wbp/lrn'];
Data.mem_ons_dir = [rtdir 'onsets/noMV_noval_1stv2nd_wbp/mem'];
