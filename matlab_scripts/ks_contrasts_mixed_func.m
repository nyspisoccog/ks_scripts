...
for i=1:numel(subjects)
    ...
    for lm = 1:numel(sess_type)
        if strcmp(sess_type{lm}, 'lrn')
            ...
            con_struct(4).contrasts(3).cnt = Ycount;
            con_struct(4).contrasts(3).con = 1;
            con_struct(4).contrasts(4).name = 'LNRS*bf(1)';
            con_struct(4).contrasts(4).cnt = Ycount;
            ...
            con_struct(8).name = 'S2vS1-Y2vY1';
            con_struct(8).contrasts(1).name = 'S2*bf(1)';
            con_struct(8).contrasts(1).cnt = Scount;
            con_struct(8).contrasts(1).con = 1;
            con_struct(8).contrasts(2).name = 'S1*bf(1)';
            con_struct(8).contrasts(2).cnt = Scount;
            con_struct(8).contrasts(2).con = -1;
            con_struct(8).contrasts(3).name = 'Y2*bf(1)';
            con_struct(8).contrasts(3).cnt = Ycount;
            con_struct(8).contrasts(3).con = -1;
            con_struct(8).contrasts(4).name = 'Y1*bf(1)';
            con_struct(8).contrasts(4).cnt = Ycount;
            con_struct(8).contrasts(4).con = 1;
            con_struct(8).convec = convec;
            con_struct(9).name = 'S2vYN2-S1vYN1';
            con_struct(9).contrasts(1).name = 'S2*bf(1)';
            con_struct(9).contrasts(1).cnt = Scount;
            con_struct(9).contrasts(1).con = 1;
            con_struct(9).contrasts(2).name = 'Y2*bf(1)';
            con_struct(9).contrasts(2).cnt = Ycount;
            con_struct(9).contrasts(2).con = -.5;
            con_struct(9).contrasts(3).name = 'N2*bf(1)';
            con_struct(9).contrasts(3).cnt = Ncount;
            con_struct(9).contrasts(3).con = -.5;
            con_struct(9).contrasts(4).name = 'S1*bf(1)';
            con_struct(9).contrasts(4).cnt = Scount;
            con_struct(9).contrasts(4).con = -1;
            con_struct(9).contrasts(5).name = 'Y1*bf(1)';
            con_struct(9).contrasts(5).cnt = Ycount;
            con_struct(9).contrasts(5).con = .5;
            con_struct(9).contrasts(6).name = 'N1*bf(1)';
            con_struct(9).contrasts(6).cnt = Ncount;
            con_struct(9).contrasts(6).con = .5;
            con_struct(9).convec = convec;
            con_struct(10).name = 'S2vY2';
            con_struct(10).contrasts(1).name = 'S2*bf(1)';
            con_struct(10).contrasts(1).cnt = Scount;
            con_struct(10).contrasts(1).con = 1;
            con_struct(10).contrasts(2).name = 'Y2*bf(1)';
            con_struct(10).contrasts(2).cnt = Ycount;
            con_struct(10).contrasts(2).con = -1;
            con_struct(10).convec = convec;
            con_struct(11).name = 'S2vN2';
            con_struct(11).contrasts(1).name = 'S2*bf(1)';
            con_struct(11).contrasts(1).cnt = Scount;
            con_struct(11).contrasts(1).con = 1;
            con_struct(11).contrasts(2).name = 'N2*bf(1)';
            con_struct(11).contrasts(2).cnt = Ncount;
            con_struct(11).contrasts(2).con = -1;
            con_struct(11).convec = convec;
            con_struct(12).name = 'S2vNY2';
            con_struct(12).contrasts(1).name = 'S2*bf(1)';
            con_struct(12).contrasts(1).cnt = Scount;
            con_struct(12).contrasts(1).con = 1;
            con_struct(12).contrasts(2).name = 'Y2*bf(1)';
            con_struct(12).contrasts(2).cnt = Ycount;
            con_struct(12).contrasts(2).con = -.5;
            con_struct(12).contrasts(3).name = 'N2*bf(1)';
            con_struct(12).contrasts(3).cnt = Ncount;
            con_struct(12).contrasts(3).con = -.5;
            con_struct(12).convec = convec;
            con_struct(13).name = 'S2vS1-N2vN1';
            con_struct(13).contrasts(1).name = 'S2*bf(1)';
            con_struct(13).contrasts(1).cnt = Scount;
            con_struct(13).contrasts(1).con = 1;
            con_struct(13).contrasts(2).name = 'S1*bf(1)';
            con_struct(13).contrasts(2).cnt = Scount;
            con_struct(13).contrasts(2).con = -1;
            con_struct(13).contrasts(3).name = 'N2*bf(1)';
            con_struct(13).contrasts(3).cnt = Ycount;
            con_struct(13).contrasts(3).con = -1;
            con_struct(13).contrasts(4).name = 'N1*bf(1)';
            con_struct(13).contrasts(4).cnt = Ycount;
            con_struct(13).contrasts(4).con = 1;
            con_struct(13).convec = convec;
            con_struct(14).name = 'SvY';
            con_struct(14).contrasts(1).name = 'S1*bf(1)';
            con_struct(14).contrasts(1).cnt = Scount;
            con_struct(14).contrasts(1).con = 1;
            con_struct(14).contrasts(2).name = 'S2*bf(1)';
            con_struct(14).contrasts(2).cnt = Scount;
            con_struct(14).contrasts(2).con = 1;
            con_struct(14).contrasts(3).name = 'Y1*bf(1)';
            con_struct(14).contrasts(3).cnt = Ycount;
            con_struct(14).contrasts(3).con = -1;
            con_struct(14).contrasts(4).name = 'Y2*bf(1)';
            con_struct(14).contrasts(4).cnt = Ycount;
            con_struct(14).contrasts(4).con = -1;
            con_struct(14).convec = convec;
            con_struct(15).name = 'SvN';
            con_struct(15).contrasts(1).name = 'S1*bf(1)';
            con_struct(15).contrasts(1).cnt = Scount;
            con_struct(15).contrasts(1).con = 1;
            con_struct(15).contrasts(2).name = 'S2*bf(1)';
            con_struct(15).contrasts(2).cnt = Scount;
            con_struct(15).contrasts(2).con = 1;
            con_struct(15).contrasts(3).name = 'N1*bf(1)';
            con_struct(15).contrasts(3).cnt = Ycount;
            con_struct(15).contrasts(3).con = -1;
            con_struct(15).contrasts(4).name = 'N2*bf(1)';
            con_struct(15).contrasts(4).cnt = Ycount;
            con_struct(15).contrasts(4).con = -1;
            con_struct(15).convec = convec;
            for j = 1:numel(names) 
