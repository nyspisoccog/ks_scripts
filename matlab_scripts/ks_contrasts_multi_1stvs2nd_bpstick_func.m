...
for i=1:numel(subjects)
    ...
    for lm = 1:numel(sess_type)
        if strcmp(sess_type{lm}, 'lrn')
            ...
            con_struct(7).name = 'SvN';
            con_struct(7).contrasts(1).name = 'LSRS*bf(1)';
            con_struct(7).contrasts(1).cnt = SScount;
            con_struct(7).contrasts(1).con = 1;
            con_struct(7).contrasts(2).name = 'LSRF*bf(1)';
            con_struct(7).contrasts(2).cnt = SFcount;
            con_struct(7).contrasts(2).con = 1;
            con_struct(7).contrasts(3).name = 'LSIS*bf(1)';
            con_struct(7).contrasts(3).cnt = SScount;
            con_struct(7).contrasts(3).con = -1;
            con_struct(7).contrasts(4).name = 'LSIF*bf(1)';
            con_struct(7).contrasts(4).cnt = SFcount;
            con_struct(7).contrasts(4).con = -1;
            con_struct(7).contrasts(5).name = 'LNRS*bf(1)';
            con_struct(7).contrasts(5).cnt = NScount;
            con_struct(7).contrasts(5).con = -1;
            con_struct(7).contrasts(6).name = 'LNRF*bf(1)';
            con_struct(7).contrasts(6).cnt = NFcount;
            con_struct(7).contrasts(6).con = -1;
            con_struct(7).contrasts(7).name = 'LNIS*bf(1)';
            con_struct(7).contrasts(7).cnt = NScount;
            con_struct(7).contrasts(7).con = 1;
            con_struct(7).contrasts(8).name = 'LNIF*bf(1)';
            con_struct(7).contrasts(8).cnt = NFcount;
            con_struct(7).contrasts(8).con = 1;
            con_struct(7).convec = convec;
            con_struct(8).name = 'SvY';
            con_struct(8).contrasts(1).name = 'LSRS*bf(1)';
            con_struct(8).contrasts(1).cnt = SScount;
            con_struct(8).contrasts(1).con = 1;
            con_struct(8).contrasts(2).name = 'LSRF*bf(1)';
            con_struct(8).contrasts(2).cnt = SFcount;
            con_struct(8).contrasts(2).con = 1;
            con_struct(8).contrasts(3).name = 'LSIS*bf(1)';
            con_struct(8).contrasts(3).cnt = SScount;
            con_struct(8).contrasts(3).con = -1;
            con_struct(8).contrasts(4).name = 'LSIF*bf(1)';
            con_struct(8).contrasts(4).cnt = SScount;
            con_struct(8).contrasts(4).con = -1;
            con_struct(8).contrasts(5).name = 'LYRS*bf(1)';
            con_struct(8).contrasts(5).cnt = YScount;
            con_struct(8).contrasts(5).con = -1;
            con_struct(8).contrasts(6).name = 'LYRF*bf(1)';
            con_struct(8).contrasts(6).cnt = YFcount;
            con_struct(8).contrasts(6).con = -1;
            con_struct(8).contrasts(7).name = 'LYIS*bf(1)';
            con_struct(8).contrasts(7).cnt = YScount;
            con_struct(8).contrasts(7).con = 1;
            con_struct(8).contrasts(8).name = 'LYIF*bf(1)';
            con_struct(8).contrasts(8).cnt = YFcount;
            con_struct(8).contrasts(8).con = 1;
            con_struct(8).convec = convec;
            con_struct(9).name = 'SvYN';
            con_struct(9).contrasts(1).name = 'LSRS*bf(1)';
            con_struct(9).contrasts(1).cnt = SScount;
            con_struct(9).contrasts(1).con = 1;
            con_struct(9).contrasts(2).name = 'LSRF*bf(1)';
            con_struct(9).contrasts(2).cnt = SFcount;
            con_struct(9).contrasts(2).con = 1;
            con_struct(9).contrasts(3).name = 'LSIS*bf(1)';
            con_struct(9).contrasts(3).cnt = SScount;
            con_struct(9).contrasts(3).con = -1;
            con_struct(9).contrasts(4).name = 'LSIF*bf(1)';
            con_struct(9).contrasts(4).cnt = SScount;
            con_struct(9).contrasts(4).con = -1;
            con_struct(9).contrasts(5).name = 'LYRS*bf(1)';
            con_struct(9).contrasts(5).cnt = YScount;
            con_struct(9).contrasts(5).con = -.5;
            con_struct(9).contrasts(6).name = 'LYRF*bf(1)';
            con_struct(9).contrasts(6).cnt = YFcount;
            con_struct(9).contrasts(6).con = -.5;
            con_struct(9).contrasts(7).name = 'LYIS*bf(1)';
            con_struct(9).contrasts(7).cnt = YScount;
            con_struct(9).contrasts(7).con = .5;
            con_struct(9).contrasts(8).name = 'LYIF*bf(1)';
            con_struct(9).contrasts(8).cnt = YFcount;
            con_struct(9).contrasts(8).con = .5;
            con_struct(9).contrasts(9).name = 'LNRS*bf(1)';
            con_struct(9).contrasts(9).cnt = NScount;
            con_struct(9).contrasts(9).con = -.5;
            con_struct(9).contrasts(10).name = 'LNRF*bf(1)';
            con_struct(9).contrasts(10).cnt = NFcount;
            con_struct(9).contrasts(10).con = -.5;
            con_struct(9).contrasts(11).name = 'LNIS*bf(1)';
            con_struct(9).contrasts(11).cnt = NScount;
            con_struct(9).contrasts(11).con = .5;
            con_struct(9).contrasts(12).name = 'LNIF*bf(1)';
            con_struct(9).contrasts(12).cnt = NFcount;
            con_struct(9).contrasts(12).con = .5;
            for j = 1:numel(names) 
