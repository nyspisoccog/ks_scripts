function ks_contrasts_multi_1stvs2nd_followup_func(Data, Time)
...
for i=1:numel(subjects)
    ...
    for lm = 1:numel(sess_type)
        if strcmp(sess_type{lm}, 'lrn')
            ...
            con_struct(1).contrasts(3).name = 'LSIF*bf(1)';
            con_struct(1).contrasts(3).cnt = SFcount;
            con_struct(1).contrasts(3).con = 1;
            con_struct(1).contrasts(4).name = 'LSRF*bf(1)';
            con_struct(1).contrasts(4).cnt = SFcount;
            con_struct(1).contrasts(4).con = -1;
            con_struct(1).convec = convec;
            con_struct(2).name = 'Y:RvIandSvF';
            con_struct(2).contrasts(1).name = 'LYIS*bf(1)';
            con_struct(2).contrasts(1).cnt = YScount;
            con_struct(2).contrasts(1).con = -1;
            con_struct(2).contrasts(2).name = 'LYRS*bf(1)';
            con_struct(2).contrasts(2).cnt = YScount;
            con_struct(2).contrasts(2).con = 1;
            con_struct(2).contrasts(3).name = 'LYIF*bf(1)';
            con_struct(2).contrasts(3).cnt = YFcount;
            con_struct(2).contrasts(3).con = 1;
            con_struct(2).contrasts(4).name = 'LYRF*bf(1)';
            con_struct(2).contrasts(4).cnt = YFcount;
            con_struct(2).contrasts(4).con = -1;
            con_struct(2).convec = convec;
            con_struct(3).name = 'S:R:2-1';
            con_struct(3).contrasts(1).name = 'LSRS*bf(1)';
            con_struct(3).contrasts(1).cnt = SScount;
            con_struct(3).contrasts(1).con = 1;
            con_struct(3).contrasts(2).name = 'LSRF*bf(1)';
            con_struct(3).contrasts(2).cnt = SFcount;
            con_struct(3).contrasts(2).con = -1;
            con_struct(3).convec = convec
            con_struct(4).name = 'S:I:2-1';
            con_struct(4).contrasts(1).name = 'LSIS*bf(1)';
            con_struct(4).contrasts(1).cnt = SScount;
            con_struct(4).contrasts(1).con = 1;
            con_struct(4).contrasts(2).name = 'LSIF*bf(1)';
            con_struct(4).contrasts(2).cnt = SFcount;
            con_struct(4).contrasts(2).con = -1;
            con_struct(4).convec = convec;
            con_struct(5).name = 'S:2:R-I';
            con_struct(5).contrasts(1).name = 'LSRS*bf(1)';
            con_struct(5).contrasts(1).cnt = SScount;
            con_struct(5).contrasts(1).con = 1;
            con_struct(5).contrasts(2).name = 'LSIS*bf(1)';
            con_struct(5).contrasts(2).cnt = SScount;
            con_struct(5).contrasts(2).con = -1;
            con_struct(5).convec = convec
            con_struct(6).name = 'S:1:R-I';
            con_struct(6).contrasts(1).name = 'LSRF*bf(1)';
            con_struct(6).contrasts(1).cnt = SFcount;
            con_struct(6).contrasts(1).con = 1;
            con_struct(6).contrasts(2).name = 'LSIF*bf(1)';
            con_struct(6).contrasts(2).cnt = SFcount;
            con_struct(6).contrasts(2).con = -1;
            con_struct(6).convec = convec;
            con_struct(7).name = 'Y:R:2-1';
            con_struct(7).contrasts(1).name = 'LYRS*bf(1)';
            con_struct(7).contrasts(1).cnt = YScount;
            con_struct(7).contrasts(1).con = 1;
            con_struct(7).contrasts(2).name = 'LYRF*bf(1)';
            con_struct(7).contrasts(2).cnt = YFcount;
            con_struct(7).contrasts(2).con = -1;
            con_struct(7).convec = convec;
            con_struct(8).name = 'Y:I:2-1';
            con_struct(8).contrasts(1).name = 'LYIS*bf(1)';
            con_struct(8).contrasts(1).cnt = YScount;
            con_struct(8).contrasts(1).con = 1;
            con_struct(8).contrasts(2).name = 'LYIF*bf(1)';
            con_struct(8).contrasts(2).cnt = YFcount;
            con_struct(8).contrasts(2).con = -1;
            con_struct(8).convec = convec;
            con_struct(9).name = 'Y:2:R-I';
            con_struct(9).contrasts(1).name = 'LYRS*bf(1)';
            con_struct(9).contrasts(1).cnt = YScount;
            con_struct(9).contrasts(1).con = 1;
            con_struct(9).contrasts(2).name = 'LYIS*bf(1)';
            con_struct(9).contrasts(2).cnt = YScount;
            con_struct(9).contrasts(2).con = -1;
            con_struct(9).convec = convec;
            con_struct(10).name = 'Y:1:R-I';
            con_struct(10).contrasts(1).name = 'LYRF*bf(1)';
            con_struct(10).contrasts(1).cnt = YFcount;
            con_struct(10).contrasts(1).con = 1;
            con_struct(10).contrasts(2).name = 'LYIF*bf(1)';
            con_struct(10).contrasts(2).cnt = YFcount;
            con_struct(10).contrasts(2).con = -1;
            con_struct(10).convec = convec;
            con_struct(11).name = 'button_press';
            con_struct(11).contrasts(1).name = 'button_press*bf(1)';
            con_struct(11).contrasts(1).cnt = 1;
