...
for i=1:numel(subjects)
    ...
    for lm = 1:numel(sess_type)
        if strcmp(sess_type{lm}, 'mem')
            ...
            con_struct(5).name = 'S:RvIandTvU'
            con_struct(5).contrasts(1).name = 'MSRT*bf(1)';
            con_struct(5).contrasts(1).cnt = Scount;
            con_struct(5).contrasts(1).con = 1;
            con_struct(5).contrasts(2).name = 'MSRU*bf(1)';
            con_struct(5).contrasts(2).cnt = Scount;
            con_struct(5).contrasts(2).con = -1;
            con_struct(5).contrasts(3).name = 'MSIT*bf(1)';
            con_struct(5).contrasts(3).cnt = Scount;
            con_struct(5).contrasts(3).con = 1;
            con_struct(5).contrasts(4).name = 'MSIU*bf(1)';
            con_struct(5).contrasts(4).cnt = Scount;
            con_struct(5).contrasts(4).con = -1;
            con_struct(5).convec = convec;
            con_struct(6).name = 'YN:RvIandTvU';
            con_struct(6).contrasts(1).name = 'MYRT*bf(1)';
            con_struct(6).contrasts(1).cnt = Ycount;
            con_struct(6).contrasts(1).con = .5;
            con_struct(6).contrasts(2).name = 'MYRU*bf(1)';
            con_struct(6).contrasts(2).cnt = Ycount;
            con_struct(6).contrasts(2).con = -.5;
            con_struct(6).contrasts(3).name = 'MYIT*bf(1)';
            con_struct(6).contrasts(3).cnt = Ycount;
            con_struct(6).contrasts(3).con = -.5;
            con_struct(6).contrasts(4).name = 'MYIU*bf(1)';
            con_struct(6).contrasts(4).cnt = Ycount;
            con_struct(6).contrasts(4).con = .5;
            con_struct(6).contrasts(5).name = 'MNRT*bf(1)';
            con_struct(6).contrasts(5).cnt = Ncount;
            con_struct(6).contrasts(5).con = .5;
            con_struct(6).contrasts(6).name = 'MNRU*bf(1)';
            con_struct(6).contrasts(6).cnt = Ncount;
            con_struct(6).contrasts(6).con = -.5;
            con_struct(6).contrasts(7).name = 'MNIT*bf(1)';
            con_struct(6).contrasts(7).cnt = Ncount;
            con_struct(6).contrasts(7).con = -.5;
            con_struct(6).contrasts(8).name = 'MNIU*bf(1)';
            con_struct(6).contrasts(8).cnt = Ncount;
            con_struct(6).contrasts(8).con = .5;
            con_struct(6).convec = convec;
            con_struct(7).name = 'S:R:T-U';
            con_struct(7).contrasts(1).name = 'MSRT*bf(1)';
            con_struct(7).contrasts(1).cnt = Scount;
            con_struct(7).contrasts(1).con = 1;
            con_struct(7).contrasts(2).name = 'MSRU*bf(1)';
            con_struct(7).contrasts(2).cnt = Scount;
            con_struct(7).contrasts(2).con = -1;
            con_struct(7).convec = convec;
            con_struct(8).name = 'YN:R:T-U';
            con_struct(8).contrasts(1).name = 'MYRT*bf(1)';
            con_struct(8).contrasts(1).cnt = Ycount;
            con_struct(8).contrasts(1).con = .5;
            con_struct(8).contrasts(2).name = 'MYRU*bf(1)';
            con_struct(8).contrasts(2).cnt = Ycount;
            con_struct(8).contrasts(2).con = -.5;
            con_struct(8).contrasts(3).name = 'MNRT*bf(1)';
            con_struct(8).contrasts(3).cnt = Ncount;
            con_struct(8).contrasts(3).con = .5;
            con_struct(8).contrasts(4).name = 'MYRU*bf(1)';
            con_struct(8).contrasts(4).cnt = Ncount;
            con_struct(8).contrasts(4).con = -.5;
            con_struct(8).convec = convec;
            con_struct(9).name = 'S:I:T-U';
            con_struct(9).contrasts(1).name = 'MSIT*bf(1)';
            con_struct(9).contrasts(1).cnt = Scount;
            con_struct(9).contrasts(1).con = 1;
            con_struct(9).contrasts(2).name = 'MSIU*bf(1)';
            con_struct(9).contrasts(2).cnt = Scount;
            con_struct(9).contrasts(2).con = -1;
            con_struct(9).convec = convec;
            con_struct(10).name = 'YN:I:T-U';
            con_struct(10).contrasts(1).name = 'MYIT*bf(1)';
            con_struct(10).contrasts(1).cnt = Ycount;
            con_struct(10).contrasts(1).con = .5;
            con_struct(10).contrasts(2).name = 'MYIU*bf(1)';
            con_struct(10).contrasts(2).cnt = Ycount;
            con_struct(10).contrasts(2).con = -.5;
            con_struct(10).contrasts(3).name = 'MNIT*bf(1)';
            con_struct(10).contrasts(3).cnt = Ncount;
            con_struct(10).contrasts(3).con = .5;
            con_struct(10).contrasts(4).name = 'MNIU*bf(1)';
            con_struct(10).contrasts(4).cnt = Ncount;
            con_struct(10).contrasts(4).con = -.5;
            con_struct(10).convec = convec;
            con_struct(11).name = 'S:T:R-I';
            con_struct(11).contrasts(1).name = 'MSRT*bf(1)';
            con_struct(11).contrasts(1).cnt = Scount;
            con_struct(11).contrasts(1).con = 1;
            con_struct(11).contrasts(2).name = 'MSIT*bf(1)';
            con_struct(11).contrasts(2).cnt = Scount;
            con_struct(11).contrasts(2).con = -1;
            con_struct(11).convec = convec;
            con_struct(12).name = 'YN:T:R-I';
            con_struct(12).contrasts(1).name = 'MYRT*bf(1)';
            con_struct(12).contrasts(1).cnt = Ycount;
            con_struct(12).contrasts(1).con = .5;
            con_struct(12).contrasts(2).name = 'MYIT*bf(1)';
            con_struct(12).contrasts(2).cnt = Ycount;
            con_struct(12).contrasts(2).con = -.5;
            con_struct(12).contrasts(3).name = 'MNRT*bf(1)';
            con_struct(12).contrasts(3).cnt = Ncount;
            con_struct(12).contrasts(3).con = .5;
            con_struct(12).contrasts(4).name = 'MNIT*bf(1)';
            con_struct(12).contrasts(4).cnt = Ncount;
            con_struct(12).contrasts(4).con = -.5;
            con_struct(12).convec = convec;
            con_struct(13).name = 'S:U:R-I';
            con_struct(13).contrasts(1).name = 'MSRU*bf(1)';
            con_struct(13).contrasts(1).cnt = Scount;
            con_struct(13).contrasts(1).con = 1;
            con_struct(13).contrasts(2).name = 'MSIU*bf(1)';
            con_struct(13).contrasts(2).cnt = Scount;
            con_struct(13).contrasts(2).con = -1;
            con_struct(13).convec = convec;
            con_struct(14).name = 'YN:U:R-I';
            con_struct(14).contrasts(1).name = 'MYRU*bf(1)';
            con_struct(14).contrasts(1).cnt = Ycount;
            con_struct(14).contrasts(1).con = .5;
            con_struct(14).contrasts(2).name = 'MYIU*bf(1)';
            con_struct(14).contrasts(2).cnt = Ycount;
            con_struct(14).contrasts(2).con = -.5;
            con_struct(14).contrasts(3).name = 'MNRU*bf(1)';
            con_struct(14).contrasts(3).cnt = Ncount;
            con_struct(14).contrasts(3).con = .5;
            con_struct(14).contrasts(4).name = 'MNIU*bf(1)';
            con_struct(14).contrasts(4).cnt = Ncount;
            con_struct(14).contrasts(4).con = -.5;
