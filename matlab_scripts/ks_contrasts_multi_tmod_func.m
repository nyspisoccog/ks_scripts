function ks_contrasts_multi_tmod_func(Data, Time)
...
for i=1:numel(subjects)
    ...
    for lm = 1:numel(sess_type)
        if strcmp(sess_type{lm}, 'lrn')
            ...
            con_struct(3).name = 'SvYt';
            con_struct(3).contrasts(1).name = 'LSIxtime^1*bf(1)';
            con_struct(3).contrasts(1).cnt = Scount;
            con_struct(3).contrasts(1).con = -1;
            con_struct(3).contrasts(2).name = 'LSRxtime^1*bf(1)';
            con_struct(3).contrasts(2).cnt = Scount;
            con_struct(3).contrasts(2).con = 1;
            con_struct(3).contrasts(3).name = 'LYIxtime^1*bf(1)';
            con_struct(3).contrasts(3).cnt = Ycount;
            con_struct(3).contrasts(3).con = 1;
            con_struct(3).contrasts(4).name = 'LYRxtime^1*bf(1)';
            con_struct(3).contrasts(4).cnt = Ycount;
            con_struct(3).contrasts(4).con = -1;
            con_struct(3).convec = convec;
            con_struct(4).name = 'SvYNt';
            con_struct(4).contrasts(1).name = 'LSIxtime^1*bf(1)';
            con_struct(4).contrasts(1).cnt = Scount;
            con_struct(4).contrasts(1).con = -1;
            con_struct(4).contrasts(2).name = 'LSRxtime^1*bf(1)';
            con_struct(4).contrasts(2).cnt = Scount;
            con_struct(4).contrasts(2).con = 1;
            con_struct(4).contrasts(3).name = 'LYIxtime^1*bf(1)';
            con_struct(4).contrasts(3).cnt = Ycount;
            con_struct(4).contrasts(3).con = .5;
            con_struct(4).contrasts(4).name = 'LYRxtime^1*bf(1)';
            con_struct(4).contrasts(4).cnt = Ycount;
            con_struct(4).contrasts(4).con = -.5;
            con_struct(4).contrasts(5).name = 'LNIxtime*bf(1)';
            con_struct(4).contrasts(5).cnt = Ncount;
            con_struct(4).contrasts(5).con = .5;
            con_struct(4).contrasts(6).name = 'LNRxtime*bf(1)';
            con_struct(4).contrasts(6).cnt = Ncount;
            con_struct(4).contrasts(6).con = -.5;
            con_struct(4).convec = convec;
            con_struct(5).name = 'LSIxtime';
            con_struct(5).contrasts(1).name = 'LSIxtime^1*bf(1)';
            con_struct(5).contrasts(1).cnt = Scount;
            con_struct(5).contrasts(1).con = 1;
            con_struct(5).convec = convec;
            con_struct(6).name = 'LSRxtime';
            con_struct(6).contrasts(1).name = 'LSRxtime^1*bf(1)';
            con_struct(6).contrasts(1).cnt = 1;
            con_struct(6).contrasts(1).con = 1;
            con_struct(6).convec = convec;
            con_struct(7).name = 'LYIxtime';
            con_struct(7).contrasts(1).name = 'LYIxtime^1*bf(1)';
            con_struct(7).contrasts(1).cnt = 1;
            con_struct(7).contrasts(1).con = 1;
            con_struct(7).convec = convec;
            con_struct(8).name = 'LYRxtime';
            con_struct(8).contrasts(1).name = 'LYRxtime^1*bf(1)';
            con_struct(8).contrasts(1).cnt = 1;
            con_struct(8).contrasts(1).con = 1;
            con_struct(8).convec = convec;
            con_struct(9).name = 'LNIxtime';
            con_struct(9).contrasts(1).name = 'LNIxtime^1*bf(1)';
            con_struct(9).contrasts(1).cnt = 1;
            con_struct(9).contrasts(1).con = 1;
            con_struct(9).convec = convec;
            con_struct(10).name = 'LNRxtime';
            con_struct(10).contrasts(1).name = 'LNRxtime^1*bf(1)';
            con_struct(10).contrasts(1).cnt = 1;
