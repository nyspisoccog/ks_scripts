...
source = '/media/truecrypt1/SocCog/SocCog_Raw_Data_By_Exam_Number'

lst = '/media/SocCog/sub-exam-matching.csv'
...
uf.done(root, "getRawfromExamDir.py, program to retrieve files from raw exam directories, has finished")
