...
with open(os.path.join(root, 'ks-trialsdata-noMV-singtri.csv'), 'w') as out:
    ...
    for sub in subs:
        ...
        for run in sub.runs:
            ...
            for trial in run.trials:
                ...
                trial.append(bp)
                bp = ''
                if trial[2] == 'R': relcount += 1
                if trial[2] == 'I': relcount += 1
                if trial[3] == 'pos': val = '+'
                elif trial[3] == 'neg':val = '-'
                else:val = ''
                sing_tri_cond = trial[0][0] + trial[1] + trial[2]  + str(relcount) + val
