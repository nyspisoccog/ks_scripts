...
header = ['subject', 'run', 'fullcond', 'type', 'rel', 'val', 'taught', 'half', 'onset', 'offset', 'RT', 'ans', 'BP']

with open(os.path.join(root, 'ks-trialsdata-wtrialtypename-val-1stv2nd.csv'), 'w') as out:
