...
#this version of onsetxtract_bp takes care of missing values and omits valence as a condition
#it also contrasts the first and second half of a learning run
#finally the onsets are stick functions timed to the button press, not 4000 ms epochs timed to the
...
root = '/media/truecrypt1/SocCog/onsets/bp_onsets_noMV_noval_1stv2nd'
