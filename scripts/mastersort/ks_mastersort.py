...
src_root = '/ifs/scratch/pimri/soccog/old/SocCog_Raw_Data_By_Exam_Number'
dirInfo = '/ifs/scratch/pimri/soccog/scripts/mastersort/subj-exam-dir-matching.csv'
scripts_dir = '/ifs/scratch/pimri/soccog/scripts/mastersort/scripts_dir'
...
for line in csv.DictReader(lst, dialect='excel', delimiter=','):
    ...
    cnv_dir = '/ifs/scratch/pimri/soccog/scripts/mastersort/scripts_dir/cnv'
    cln_dir = '/ifs/scratch/pimri/soccog/scripts/mastersort/scripts_dir/cln'
	...
	p.write("from __future__ import with_statement"+ "\n")
