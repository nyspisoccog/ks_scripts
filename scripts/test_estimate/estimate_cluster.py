...
# (1) the name of the directory that cotains the generic files, where the m-files, qsub scripts, and submission
...
# "import estimate_cluster" at the beginning of your script.  You could then call job_spec(arg1, arg2, arg3, arg4)
# and/or submit_job(arg1) with the appropriate arguments
#
...
#subs = ['7408', '7412', '7414', '7418', '7430']

#mat_file_dir = '/ifs/scratch/pimri/scripts/test_estimate/mat_files'

#script_dir = '/ifs/scratch/pimri/soccog/scripts/test_estimate'

#log_dir = '/ifs/scratch/pimri/scripts/test_estimate/logdir'
