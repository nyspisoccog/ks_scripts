...
Data.res_dir = [rtdir 'scripts/test_estimate/mat_files/']; 
...
Data.bp_ons_dir  = [rtdir 'onsets/bp'];
Data.lrn_ons_dir = [rtdir 'onsets/noMV_noval_no1st/lrn'];
Data.mem_ons_dir = [rtdir 'onsets/noMV_noval_no1st/mem'];
