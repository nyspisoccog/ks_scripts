dirList = dir('/ifs/scratch/pimri/soccog/7418/anat/s1106112_160_s10/dicoms');
for i=1:length(dirList)
   ...
   if ~dirList(i).isdir
       ...
       if extension == 'dcm'
           info=dicominfo(['/ifs/scratch/pimri/soccog/7418/anat/s1106112_160_s10/dicoms/' dirList(i).name]);
           ...
           info.BitsStored=12;
           info.HighBit=11;
           d=dicomread(['/ifs/scratch/pimri/soccog/7418/anat/s1106112_160_s10/dicoms/' dirList(i).name]);
           mkdir('/ifs/scratch/pimri/soccog/7418/anat/s1106112_160_s10/dicoms/anonout');
           dicomwrite(d, ['/ifs/scratch/pimri/soccog/7418/anat/s1106112_160_s10/dicoms/anonout/' dirList(i).name], info, 'createmode', 'copy', 'BitDepth', 12, 'BitsStored', 12, 'HighBit', 11);
       end
   end
end
exit()