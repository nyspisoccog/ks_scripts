...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1202-TQETMR/anatomical/Time1/1918-Anat-1/dicoms/i1939092.MRDC.4 -subject s1918-Anat-1 -all -qcache