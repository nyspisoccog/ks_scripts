...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1203-JONEGQ/anatomical/Time1/2071-Anat-2/dicoms/i3980170.MRDC.4 -subject s2071-Anat-2 -all -qcache