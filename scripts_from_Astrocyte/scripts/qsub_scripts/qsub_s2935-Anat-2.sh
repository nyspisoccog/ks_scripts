...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1014-QOTSER/anatomical/Time1/2935-Anat-2/dicoms/i3915087.MRDC.1 -subject s2935-Anat-2 -all -qcache