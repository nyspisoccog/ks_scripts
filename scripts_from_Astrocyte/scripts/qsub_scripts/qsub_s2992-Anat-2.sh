...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1005-RCQPEC/anatomical/Time1/2992-Anat-2/dicoms/i4927545.MRDC.3 -subject s2992-Anat-2 -all -qcache