...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1015-OLSPCF/anatomical/Time1/3281-Anat-1/dicoms/i2690693.MRDC.2 -subject s3281-Anat-1 -all -qcache