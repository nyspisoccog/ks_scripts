...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1015-OLSPCF/anatomical/Time1/3281-Anat-2/dicoms/i2690948.MRDC.2 -subject s3281-Anat-2 -all -qcache