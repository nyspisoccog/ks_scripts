...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1016-AVJKKT/anatomical/Time1/3307-Anat-1/dicoms/i3102682.MRDC.6 -subject s3307-Anat-1 -all -qcache