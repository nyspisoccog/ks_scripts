...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1017-EKTKUK/anatomical/Time1/3344-Anat-1/dicoms/i3979697.MRDC.2 -subject s3344-Anat-1 -all -qcache