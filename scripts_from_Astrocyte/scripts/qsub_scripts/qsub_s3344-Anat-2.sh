...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1017-EKTKUK/anatomical/Time1/3344-Anat-2/dicoms/i3979863.MRDC.1 -subject s3344-Anat-2 -all -qcache