...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1209-RCUESE/anatomical/Time1/3511-Anat-2/dicoms/i2649182.MRDC.1 -subject s3511-Anat-2 -all -qcache