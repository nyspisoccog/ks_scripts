...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1009-VTSDHA/anatomical/Time2/3584-Anat-1/dicoms/i3970033.MRDC.4 -subject s3584-Anat-1 -all -qcache