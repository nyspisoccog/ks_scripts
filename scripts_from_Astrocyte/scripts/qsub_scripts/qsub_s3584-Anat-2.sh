...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1009-VTSDHA/anatomical/Time2/3584-Anat-2/dicoms/i3970192.MRDC.2 -subject s3584-Anat-2 -all -qcache