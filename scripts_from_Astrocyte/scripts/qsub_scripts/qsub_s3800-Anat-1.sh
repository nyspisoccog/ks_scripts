...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1017-EKTKUK/anatomical/Time2/3800-Anat-1/dicoms/i3258400.MRDC.2 -subject s3800-Anat-1 -all -qcache