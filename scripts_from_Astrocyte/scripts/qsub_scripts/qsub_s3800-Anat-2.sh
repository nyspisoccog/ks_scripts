...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1017-EKTKUK/anatomical/Time2/3800-Anat-2/dicoms/i3258559.MRDC.6 -subject s3800-Anat-2 -all -qcache