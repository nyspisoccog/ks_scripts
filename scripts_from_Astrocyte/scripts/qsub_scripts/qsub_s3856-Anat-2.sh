...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1016-AVJKKT/anatomical/Time2/3856-Anat-2/dicoms/i3981276.MRDC.2 -subject s3856-Anat-2 -all -qcache