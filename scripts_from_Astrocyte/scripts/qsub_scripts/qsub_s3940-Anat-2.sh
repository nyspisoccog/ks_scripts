...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1021-CPNLRS/anatomical/Time1/3940-Anat-2/dicoms/i1026668.MRDC.2 -subject s3940-Anat-2 -all -qcache