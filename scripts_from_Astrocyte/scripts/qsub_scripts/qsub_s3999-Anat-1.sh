...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1019-QSVWZF/anatomical/Time2/3999-Anat-1/dicoms/i1906739.MRDC.2 -subject s3999-Anat-1 -all -qcache