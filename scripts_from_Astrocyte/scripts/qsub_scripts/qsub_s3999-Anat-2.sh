...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1019-QSVWZF/anatomical/Time2/3999-Anat-2/dicoms/i1906910.MRDC.4 -subject s3999-Anat-2 -all -qcache