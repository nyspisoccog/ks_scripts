...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1230-CIMITU/anatomical/Time1/4070-Anat-2/dicoms/i2842418.MRDC.1 -subject s4070-Anat-2 -all -qcache