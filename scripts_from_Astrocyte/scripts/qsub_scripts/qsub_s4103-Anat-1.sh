...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1022-AKGMOY/anatomical/Time1/4103-Anat-1/dicoms/i3477301.MRDC.4 -subject s4103-Anat-1 -all -qcache