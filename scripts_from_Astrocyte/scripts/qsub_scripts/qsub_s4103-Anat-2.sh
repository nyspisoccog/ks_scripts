...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1022-AKGMOY/anatomical/Time1/4103-Anat-2/dicoms/i3477472.MRDC.3 -subject s4103-Anat-2 -all -qcache