...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1021-CPNLRS/anatomical/Time2/4427-Anat-1/dicoms/i4116493.MRDC.6 -subject s4427-Anat-1 -all -qcache