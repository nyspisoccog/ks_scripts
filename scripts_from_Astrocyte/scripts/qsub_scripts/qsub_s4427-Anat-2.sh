...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1021-CPNLRS/anatomical/Time2/4427-Anat-2/dicoms/i4116664.MRDC.2 -subject s4427-Anat-2 -all -qcache