...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1024-GTLKRG/anatomical/Time1/4637-Anat-1/dicoms/i4048833.MRDC.4 -subject s4637-Anat-1 -all -qcache