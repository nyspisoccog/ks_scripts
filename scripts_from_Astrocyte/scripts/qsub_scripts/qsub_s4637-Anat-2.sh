...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1024-GTLKRG/anatomical/Time1/4637-Anat-2/dicoms/i4049004.MRDC.4 -subject s4637-Anat-2 -all -qcache