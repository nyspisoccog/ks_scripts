...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1025-YLACEJ/anatomical/Time1/4640-Anat-1/dicoms/i4165550.MRDC.2 -subject s4640-Anat-1 -all -qcache