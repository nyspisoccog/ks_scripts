...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1025-YLACEJ/anatomical/Time1/4640-Anat-2/dicoms/i4165721.MRDC.1 -subject s4640-Anat-2 -all -qcache