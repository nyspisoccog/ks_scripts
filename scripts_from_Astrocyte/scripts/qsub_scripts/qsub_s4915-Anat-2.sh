...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Panic/1016-AVJKKT/anatomical/Time3/4915-Anat-2/dicoms/i4459606.MRDC.1 -subject s4915-Anat-2 -all -qcache