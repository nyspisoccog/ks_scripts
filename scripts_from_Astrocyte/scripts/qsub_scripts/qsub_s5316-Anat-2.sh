...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1236-EVXZHS/anatomical/Time1/5316-Anat-2/dicoms/i1951319.MRDC.2 -subject s5316-Anat-2 -all -qcache