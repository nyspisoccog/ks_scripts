...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1239-IJLPEV/anatomical/Time1/5578-Anat-2/dicoms/i2112556.MRDC.1 -subject s5578-Anat-2 -all -qcache