...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1212-PXNNOZ/anatomical/Time1/5630-Anat-2/dicoms/i3636954.MRDC.8 -subject s5630-Anat-2 -all -qcache