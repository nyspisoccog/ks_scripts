...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1213-HJPUPS/anatomical/Time1/5637-Anat-1/dicoms/i3846926.MRDC.2 -subject s5637-Anat-1 -all -qcache