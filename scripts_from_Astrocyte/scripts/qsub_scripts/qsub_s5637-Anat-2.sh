...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1213-HJPUPS/anatomical/Time1/5637-Anat-2/dicoms/i3847089.MRDC.3 -subject s5637-Anat-2 -all -qcache