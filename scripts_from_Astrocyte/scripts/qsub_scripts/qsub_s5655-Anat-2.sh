...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1214-YTNRVG/anatomical/Time1/5655-Anat-2/dicoms/i4256431.MRDC.6 -subject s5655-Anat-2 -all -qcache