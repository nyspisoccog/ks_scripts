...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1218-MKNFAR/anatomical/Time1/5873-Anat-1/dicoms/i2223864.MRDC.5 -subject s5873-Anat-1 -all -qcache