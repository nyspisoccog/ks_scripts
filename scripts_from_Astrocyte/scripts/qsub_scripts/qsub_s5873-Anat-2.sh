...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1218-MKNFAR/anatomical/Time1/5873-Anat-2/dicoms/i2224023.MRDC.2 -subject s5873-Anat-2 -all -qcache