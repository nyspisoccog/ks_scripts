...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1219-FODTFR/anatomical/Time1/5874-Anat-1/dicoms/i2287923.MRDC.4 -subject s5874-Anat-1 -all -qcache