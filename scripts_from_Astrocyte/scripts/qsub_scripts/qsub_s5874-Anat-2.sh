...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1219-FODTFR/anatomical/Time1/5874-Anat-2/dicoms/i2288082.MRDC.2 -subject s5874-Anat-2 -all -qcache