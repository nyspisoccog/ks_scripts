...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1221-AFUWNP/anatomical/Time1/5903-Anat-1/dicoms/i2929461.MRDC.1 -subject s5903-Anat-1 -all -qcache