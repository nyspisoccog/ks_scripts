...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1222-ZCGPXI/anatomical/Time1/5943-Anat-1/dicoms/i4166055.MRDC.2 -subject s5943-Anat-1 -all -qcache