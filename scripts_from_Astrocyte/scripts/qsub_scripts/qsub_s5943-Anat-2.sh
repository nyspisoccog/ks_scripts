...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1222-ZCGPXI/anatomical/Time1/5943-Anat-2/dicoms/i4166228.MRDC.4 -subject s5943-Anat-2 -all -qcache