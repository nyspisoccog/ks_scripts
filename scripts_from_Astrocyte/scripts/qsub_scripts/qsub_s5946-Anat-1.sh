...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1223-FCQJTU/anatomical/Time1/5946-Anat-1/dicoms/i4299866.MRDC.3 -subject s5946-Anat-1 -all -qcache