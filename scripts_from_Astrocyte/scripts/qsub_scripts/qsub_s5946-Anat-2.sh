...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1223-FCQJTU/anatomical/Time1/5946-Anat-2/dicoms/i4300039.MRDC.1 -subject s5946-Anat-2 -all -qcache