...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1225-DQVDJK/anatomical/Time1/5999-Anat-2/dicoms/i659553.MRDC.1 -subject s5999-Anat-2 -all -qcache