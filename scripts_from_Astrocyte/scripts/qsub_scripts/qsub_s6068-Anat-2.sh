...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1227-FQFLQT/anatomical/Time1/6068-Anat-2/dicoms/i2862410.MRDC.2 -subject s6068-Anat-2 -all -qcache