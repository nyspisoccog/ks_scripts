...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1228-XLWHED/anatomical/Time1/6087-Anat-1/dicoms/i3470040.MRDC.5 -subject s6087-Anat-1 -all -qcache