...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1242-OZVIDL/anatomical/Time1/6146-Anat-1/dicoms/i4673981.MRDC.1 -subject s6146-Anat-1 -all -qcache