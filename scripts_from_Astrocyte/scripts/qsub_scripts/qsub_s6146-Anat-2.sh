...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1242-OZVIDL/anatomical/Time1/6146-Anat-2/dicoms/i4674140.MRDC.1 -subject s6146-Anat-2 -all -qcache