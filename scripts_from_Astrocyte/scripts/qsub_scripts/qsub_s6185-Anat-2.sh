...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1245-ZLVWZH/anatomical/Time1/6185-Anat-2/dicoms/i103.MRDC.30 -subject s6185-Anat-2 -all -qcache