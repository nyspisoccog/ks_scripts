...
recon-all -i /ifs/scratch/pimri/pyschotherapy/data/Controls/1246-URHDVU/anatomical/Time1/6247-Anat-2/dicoms/i1887223.MRDC.3 -subject s6247-Anat-2 -all -qcache